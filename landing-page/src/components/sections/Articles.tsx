          ...
          {scamArticles.length > 0 && (
            <div className="lg:col-span-2 md:flex-nowrap flex-wrap flex p-6 gap-4 bg-white rounded-lg overflow-hidden">
              ...
              <div className="md:p-6">
                <span className="text-sm bg-tw_primary/10 tw-font-medium px-4 py-1 text-tw_primary rounded-full">
                  Featured
                </span>
                <h3 className="text-2xl tw-font-bold my-4">
                  {scamArticles[0].title}
                </h3>
                <p className="text-gray-600 tw-font-regular mb-4">
                  {scamArticles[0].content.substring(0, 250)}...
                </p>
                <div className="flex items-center tw-font-medium text-gray-500 text-sm">
                  ...
                  <span>
                    &middot;{" "}
                    {new Date(scamArticles[0].date).toLocaleDateString()}
                  </span>
                </div>
              </div>
            </div>
              ...
              <SwiperSlide key={article.id} className="h-full py-16">
                <div className="bg-white flex rounded-lg overflow-hidden h-auto p-5">
                  ...
                  <div className="p-4 flex flex-col gap-4 justify-between">
                    <div>
                      <span className="text-xs tw-font-medium px-4 py-1 rounded-full   bg-tw_primary/10 text-tw_primary">
                        {article.category}
                      </span>
                      <h3 className="sm:text-lg text-base tw-font-bold my-1">
                        {article.title}
                      </h3>

      ...
      <div className="tw_container relative w-full mx-auto max-w-[90%] py-10">
        <div className="w-full flex justify-between relative gap-8 ds:flex-wrap md:flex-nowrap">
          <div className="space-y-4 md:w-[60%]">
            ...
            {/* <p className=" md:max-w-md text-base absolute bottom-0 left-0 tw-font-regular leading-6 ">
          ...
          <div className="flex md:w-[60%] items-center gap-4 flex-wrap">
            <div className="rounded-md p-4 ds:w-full sm:w-[220px] bg-[#F9F9FB] space-y-4">
              ...
              <p className="text-sm tw-font-regular leading-6 text-[#808080]">
                the thing about using is that our agents and experts reply
                faster to meet your need
              </p>
            </div>
            <div className="rounded-md p-4 ds:w-full sm:w-[220px] bg-[#F9F9FB] space-y-4">
              <img
              ...
              <p className="text-sm tw-font-regular leading-6 text-[#808080]">
                we are always online with people working on shifts to help with
                your questions
              </p>
            </div>
            <div className="rounded-md p-4 ds:w-full sm:w-[220px] bg-[#F9F9FB] space-y-4">
              <img
                ...
                alt=""
              />
              <h1 className="text-[#0D0D0D] tw-font-medium">
                Guaranted refund
              </h1>
              <p className="text-sm tw-font-regular leading-6 text-[#808080]">
                after being to refund 80+ people in 7 months , we can say that
                we are have a high succes rate
              </p>
            </div>
            <div className="rounded-md p-4 ds:w-full sm:w-[220px] bg-[#F9F9FB] space-y-4">
              <img
              ...
              <p className="text-sm tw-font-regular leading-6 text-[#808080]">
                we have connections and affilations with many banks , so that
                money you lost? consider it refunded
              </p>
            </div>
            <div className="rounded-md p-4 ds:w-full sm:w-[220px] bg-[#F9F9FB] space-y-4">
              <img
              ...
              <p className="text-sm tw-font-regular leading-6 text-[#808080]">
                as you have seen on our website, we do have good feedbacks from
                people we've helped , and we are verified on trustpilot
              </p>
            </div>
            {/* <div className="rounded-md p-4 ds:w-full sm:w-[220px] bg-[#F9F9FB] space-y-4">
            <img
